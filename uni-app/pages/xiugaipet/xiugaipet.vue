...
<script>
	...
	export default {
		...
		onLoad() {
			...
			console.log($store.state.pet);
			
			this.pet1 = $store.state.pet;
			this.id =  this.pet1.id;
			this.petpic = this.pet1.petpic
			this.petname = this.pet1.pet_name ;
			this.sex = this.pet1.pet_sex ;
			this.birthday = this.pet1.pet_birthday ;
			this.pinzhong = this.pet1.species ;
			this.tizhong = this.pet1.weight ;
			this.jueyu = this.pet1.jueyu ;
			this.feature = this.pet1.feature ;
		},
		computed: {
			...mapState({
				pet:state=>state.pet
		...
		methods: {
			...
			submit(){
				...
				this.$H.post('/pet/'+this.id+'/editpetinfo',{
