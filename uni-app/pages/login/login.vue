		...
		<view class="px-2">
			...
			<template v-else>
				...
				<view class="mb-2 flex align-stretch">
					...
					<view class="border-bottom flex align-center justify-center font-sm text-white " :class="codeTime > 0 ? 'bg-main-disabled' : 'bg-main'" style="width: 180rpx;border-radius: 100rpx;" @click="getCode">{{codeTime > 0 ? codeTime + ' s' : '获取验证码'}}</view>
				</view>
			</template>
